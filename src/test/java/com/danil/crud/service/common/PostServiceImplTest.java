...
public class PostServiceImplTest {
    ...
    public void init() {
        ...
        setPostRepositoryGetContentById();
    }
    ...
    private void setPostRepositoryGetContentById() {
        when(postRepository.getContentById(1)).thenReturn(posts.get(0));
        when(postRepository.getContentById(1000)).thenReturn(null);
    }
    ...
    public void dellabelTest() {
        ...
        postToReturn.setLabels(new TreeSet<>());
