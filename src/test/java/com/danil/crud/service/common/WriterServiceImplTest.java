...
public class WriterServiceImplTest {
    ...
    public void init() {
        ...
        setWriterRepositorygetFirstLastNameById();
    ...
    private void setWriterRepositorygetFirstLastNameById() {
        when(writerRepository.getFirstLastNameById(1)).thenReturn(writers.get(0));
        when(writerRepository.getFirstLastNameById(1000)).thenReturn(null);
    }
